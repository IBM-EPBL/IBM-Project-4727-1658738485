...
api_key = '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'
app = Flask(__name__)
...
def login():
    ...
    if request.method == 'POST' :
        ...
        sql = "SELECT * FROM LOGIN WHERE usermail =? AND password=?"
        ...
        if account:
            ...
            session['usermail'] = account['USERNAME']
